        ...
        <div class="collapse navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="padding:12px;">
                        <form class="form-inline" method="post" action="${pageContext.request.contextPath}/posts/search">
                            ...
                            <input id="searchHinddenParamDada" name="search" value="${search}" class="form-control pull-left" placeholder="帖子标题/内容" type="text">
                        </form>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu userControlMenu">
                        <c:if test="${empty user}">

                            <li><a href="${pageContext.request.contextPath}/user/loginOrRegister">登录</a></li>
                            <%--<li><a href="#">Profile</a></li>--%>
                        </c:if>
                        <c:if test="${not empty user}">
                            <li><a href="${pageContext.request.contextPath}/user/manager">个人中心</a></li>
                            <li class="divider"></li>
                            <li><a id="logout" href="javascript:void (0);" onclick="userLogout()">注销登录</a></li>
                        </c:if>
                    </ul>
                </li>
            </ul>
